...
3. Place `[xls]` in your pages. Check the [plugin homepage](http://www.jonathanspence.com/software/wordpress-plugins/xavins-list-subpages/) for
detailed options and more complex uses.

== Frequently Asked Questions ==

Check the [plugin homepage](http://www.jonathanspence.com/software/wordpress-plugins/xavins-list-subpages/)
